...
Enemy::Enemy()
{
	...
	{
		{
			...
			animation_aim_left.set_anchor_mode(Animation::AnchorMode::BOTTOM_CENTERED);
			...
			animation_aim_right.set_anchor_mode(Animation::AnchorMode::BOTTOM_CENTERED);
...

		{
			...
			animation_dash_in_air_left.set_anchor_mode(Animation::AnchorMode::BOTTOM_CENTERED);
			...
			animation_dash_in_air_right.set_anchor_mode(Animation::AnchorMode::BOTTOM_CENTERED);
...

		{
			...
			animation_dash_on_floor_left.set_anchor_mode(Animation::AnchorMode::BOTTOM_CENTERED);
			...
			animation_dash_on_floor_right.set_anchor_mode(Animation::AnchorMode::BOTTOM_CENTERED);
...

		{
			...
			animation_squat_left.set_anchor_mode(Animation::AnchorMode::BOTTOM_CENTERED);
			...
			animation_squat_right.set_anchor_mode(Animation::AnchorMode::BOTTOM_CENTERED);
...

		{
			...
			animation_throw_barb_left.set_anchor_mode(Animation::AnchorMode::BOTTOM_CENTERED);
			...
			animation_throw_barb_right.set_anchor_mode(Animation::AnchorMode::BOTTOM_CENTERED);
...

		{
			...
			animation_throw_silk_left.set_anchor_mode(Animation::AnchorMode::BOTTOM_CENTERED);
			...
			animation_throw_silk_right.set_anchor_mode(Animation::AnchorMode::BOTTOM_CENTERED);
...

		{
			...
			animation_throw_sword_left.set_anchor_mode(Animation::AnchorMode::BOTTOM_CENTERED);
			...
			animation_throw_sword_right.set_anchor_mode(Animation::AnchorMode::BOTTOM_CENTERED);
...

	{
		...
		animation_dash_on_floor_left.set_anchor_mode(Animation::AnchorMode::CENTERED);
		...
		animation_dash_on_floor_right.set_anchor_mode(Animation::AnchorMode::CENTERED);
...
void Enemy::throw_barbs()
{
	...
	for (int i = 0; i < num_new_barb; i++)
	{
		...
		int rand_x = randint(i * width_grid, (i + 1) * width_grid);
		int rand_y = randint(250, 500);
		new_barb->set_position({ static_cast<float>(rand_x), static_cast<float>(rand_y) });
